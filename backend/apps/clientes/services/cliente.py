...
def _snapshot(cliente: Cliente) -> dict[str, Any]:
    return {
        ...
        "pais": cliente.pais,
        "cadastro_fiscal_pronto": cliente.cadastro_fiscal_pronto,
...
def create_cliente(
    *,
    ...
    cliente = Cliente(
        ...
        indicador_ie=data.get("indicador_ie", Cliente.INDICADOR_IE_NAO_CONTRIBUINTE),
        contribuinte_icms=data.get("contribuinte_icms", False),
...
def update_cliente(
    *,
    ...
    updatable = {
        ...
        "inscricao_estadual", "indicador_ie", "contribuinte_icms", "municipio_ibge",
        "codigo_pais", "pais",
